...
hese3 = function(domain, element) {
    ...
    var right_col = function(element,options,methods){
        ...
        if ('time' in event)
            html += '<div class="line"><div class="key">Time</div><div class="value">'+MJD_to_date_string(event.time)+'</div></div>';
    ...
    var html = '<h4 style="margin-bottom:0">Take a look at the 37 very high energy events found in data collected by the IceCube detector from May 2010 to May 2013. They constitute the first solid evidence for astrophysical neutrinos from cosmic accelerators.</h4>';
